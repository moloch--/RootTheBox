...
{prompt:"> ",history:true,exit:true,clear:true,enabled:true,historySize:60,checkArity:false,displayExceptions:true,cancelableAjax:true,processArguments:true,linksNoReferrer:false,login:null,outputLimit:-1,tabcompletion:null,historyFilter:null,onInit:d.noop,onClear:d.noop,onBlur:d.noop,onFocus:d.noop,onTerminalChange:d.noop,onExit:d.noop,keypress:d.noop,keydown:d.noop};var fa=[],$=new function(c){var e=c?[c]:[],i=0;d.extend(this,{get:function(){return e},rotate:function(){if(e.length===1)return e[0];
